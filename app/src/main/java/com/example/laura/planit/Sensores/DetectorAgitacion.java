package com.example.laura.planit.Sensores;
...
public class DetectorAgitacion implements SensorEventListener {
    ...
    public DetectorAgitacion(OnShakeListener shakeListener) {
    ...
    private float getMaxCurrentLinearAcceleration() {
        return Math.max(mLinearAcceleration[X],Math.max(mLinearAcceleration[Y],mLinearAcceleration[Z]));
    }
